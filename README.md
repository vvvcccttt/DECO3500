...
Afterward, users can follow the instructions provided in the "[Introduction to How the Prototype is Used](https://github.com/vvvcccttt/DECO3500/wiki/%22FamTrip%22-Design-Process-Overview#high-fidelity-prototypes)" to interact with the pages and fully experience all the features of the four parts of the web prototype.
